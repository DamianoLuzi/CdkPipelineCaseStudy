...
export class CdkAnalyticsConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string) {
    super(scope, id);
    this.eventBus = new events.EventBus(this, 'AnalyticsBus', {
...
def lambda_handler(event, context):
    ...
    new events.Rule(this, 'PostsEventRule', {
    ...
    new events.Rule(this, 'ChatEventRule', {
      eventBus: this.eventBus,
      eventPattern: {
        source: ['chat.service'],
    ...
    new events.Rule(this, 'ChatMessageEventRule', {
      eventBus: this.eventBus,
      eventPattern: {
        source: ['chat.service'],
